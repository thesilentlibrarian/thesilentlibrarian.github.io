...
<div class="_rox_refine_simulator">
  ...
  <div class="input-group">
    <label>Oridecon Price</label>
    <input id="input-phracon-price" type="number" placeholder="phracon 1 price" value="4000">
    <div class="input-desc">
      *Price for Enriched Oridecon and HD Oridecon will be derived. Enriched price is 4x, HD is 16x.
    <div>
  </div>
  <br>
  <div class="input-group">
